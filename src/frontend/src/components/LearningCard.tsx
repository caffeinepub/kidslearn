...
const LearningCard: React.FC<LearningCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <h3 className={`font-heading text-lg ${textClass} leading-tight`}>
        {name}
      </h3>
      <div
        className="mt-2 inline-block px-3 py-1.5 rounded-full text-sm font-bold font-nunito text-white"
