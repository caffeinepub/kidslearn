...
export default function ShareModal({ isOpen, onClose }: ShareModalProps) {
  ...
  const appUrl =
    typeof window !== "undefined"
      ...
      : "https://kidslearn.app";
  const shareText =
    "🌟 Check out KidsLearn! A fun app to learn Alphabets, Numbers & Words in Telugu, Hindi, Tamil & English! 🎉";
      ...
      <DialogContent className="max-w-sm rounded-3xl border-4 border-sunshine-400 bg-white p-0 overflow-hidden">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="bg-sunshine-50 border-2 border-sunshine-300 rounded-2xl px-4 py-3 flex items-center gap-3">
            ...
            <span className="font-body text-sm text-gray-600 truncate flex-1">
              {appUrl}
            </span>
          </div>
