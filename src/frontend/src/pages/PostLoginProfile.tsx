          ...
          {progressLoading ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-gradient-to-br from-sunshine-100 to-sunshine-200 border-4 border-sunshine-300 rounded-3xl p-4 text-center">
                ...
                <div className="font-heading text-xl text-sunshine-700">
                  Level {levelInfo.level}
                </div>
                <div className="font-body text-sm text-sunshine-600">
                  {levelInfo.title}
                </div>
              </div>
              {/* Points */}
              <div className="bg-gradient-to-br from-tangerine-100 to-tangerine-200 border-4 border-tangerine-300 rounded-3xl p-4 text-center">
                ...
                <div className="font-heading text-xl text-tangerine-700">
                  {totalPoints}
                </div>
                <div className="font-body text-sm text-tangerine-600">
                  Total Points
                </div>
              </div>
              {/* Lessons */}
              <div className="bg-gradient-to-br from-sky-100 to-sky-200 border-4 border-sky-300 rounded-3xl p-4 text-center">
                <div className="text-4xl mb-1">📖</div>
                <div className="font-heading text-xl text-sky-700">
              ...
              <div className="bg-gradient-to-br from-grass-100 to-grass-200 border-4 border-grass-300 rounded-3xl p-4 text-center">
                <div className="text-4xl mb-1">❓</div>
                <div className="font-heading text-xl text-grass-700">
                  {quizResults.length}
                </div>
                <div className="font-body text-sm text-grass-600">
                  Quizzes Taken
                </div>
              </div>
            </div>
