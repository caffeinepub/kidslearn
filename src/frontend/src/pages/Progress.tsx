...
const ALL_BADGES = [
  {
    ...
    label: "Math Champion",
    emoji: "🔢",
    color: "bg-tangerine-400 border-tangerine-600",
  },
  {
    id: "alphabet-quiz-badge",
    label: "Alphabet Star",
    emoji: "🔤",
    color: "bg-grass-500 border-grass-700",
  },
  {
    id: "science-quiz-badge",
    label: "Science Whiz",
    emoji: "🔬",
    color: "bg-sunshine-400 border-sunshine-600",
  },
  {
    id: "telugu-quiz-badge",
    label: "Telugu Hero",
    emoji: "🌺",
    color: "bg-cherry-400 border-cherry-600",
  },
  {
    id: "hindi-quiz-badge",
    label: "Hindi Star",
    emoji: "🪔",
    color: "bg-tangerine-500 border-tangerine-700",
  },
  {
    id: "english-quiz-badge",
    label: "English Pro",
    emoji: "📖",
    color: "bg-grass-600 border-grass-800",
  },
  {
    id: "first-lesson",
    label: "First Lesson",
  ...
  },
  {
    ...
    label: "Quiz Master",
    emoji: "🧠",
    color: "bg-lavender-500 border-lavender-700",
  },
  {
    id: "toddler-minigame-badge",
    label: "Memory Master",
    emoji: "🎴",
    color: "bg-sunshine-400 border-sunshine-600",
  },
  {
    id: "early-learner-minigame-badge",
    label: "Letter Matcher",
    emoji: "🔤",
    color: "bg-grass-500 border-grass-700",
  },
  {
    id: "older-kids-minigame-badge",
    label: "Word Wizard",
    emoji: "🔀",
    color: "bg-cherry-500 border-cherry-700",
  },
];
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-sunshine-100 to-grass-50 flex items-center justify-center px-4">
        <div className="bg-white border-4 border-sunshine-400 rounded-4xl p-8 max-w-md w-full text-center shadow-fun-xl">
          ...
          <h1 className="font-fredoka text-3xl text-sunshine-700 mb-2">
            My Progress
          </h1>
          ...
          <button
            type="button"
            onClick={() => navigate({ to: "/" })}
            className="w-full mt-3 bg-grass-400 hover:bg-grass-500 border-4 border-grass-600 text-white font-fredoka text-xl py-3 rounded-3xl shadow-fun hover:scale-105 active:scale-95 transition-all"
          >
            🚀 Keep Learning!
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-sunshine-100 to-grass-50 px-4 py-8">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="font-fredoka text-4xl text-sunshine-700 mb-2">
            My Progress
          </h1>
        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          <div className="bg-sunshine-400 border-4 border-sunshine-600 rounded-3xl p-3 text-center shadow-fun">
            <p className="font-fredoka text-white text-3xl">
              {earnedBadgeIds.size}
            </p>
            ...
            {ALL_BADGES.map((badge) => {
              ...
              return (
                ...
                >
                  ...
                  <p
                    className={`font-fredoka text-center text-sm leading-tight ${earned ? "text-white" : "text-muted-foreground"}`}
                  >
                    {badge.label}
                  </p>
                  {!earned && (
              ...
              {quizResults.map((result, i) => {
                ...
                return (
                  <div
                    ...
                    className="bg-white border-4 border-tangerine-300 rounded-2xl p-4 flex items-center gap-4 shadow-fun"
                  >
                    <div className="w-12 h-12 rounded-2xl bg-tangerine-400 flex items-center justify-center">
                      <Star className="text-white" size={24} />
                    </div>
                    <div className="flex-1">
                      <p className="font-fredoka text-lg text-foreground capitalize">
                        {result.subject}
                      </p>
                      <div className="w-full bg-muted rounded-full h-2 mt-1">
                        <div
                          className="bg-tangerine-400 h-2 rounded-full"
                          style={{ width: `${pct}%` }}
                        />
                      </div>
                    </div>
