    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-100 via-lavender-100 to-mint-100 py-6 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="font-heading text-5xl text-sky-600 drop-shadow-md mb-2">
            🗂️ Flashcards
          </h1>
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="font-heading text-3xl text-gray-800">
                {card?.front}
              </span>
            ...
            >
              <span className="font-heading text-2xl text-white text-center leading-relaxed">
                {card?.back}
              </span>
              <button
                type="button"
