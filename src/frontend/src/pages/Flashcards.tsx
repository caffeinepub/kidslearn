...
> = {
  english: {
    ...
    frontBg: "bg-sky-200 border-sky-500",
    backBg: "bg-sky-400 border-sky-600",
  },
  telugu: {
    label: "తెలుగు",
    voice: "te-IN",
    btnClass: "bg-grass-400 hover:bg-grass-500 text-white border-grass-600",
    frontBg: "bg-grass-200 border-grass-500",
    backBg: "bg-grass-400 border-grass-600",
  },
  hindi: {
    label: "हिंदी",
    voice: "hi-IN",
    ...
    frontBg: "bg-tangerine-200 border-tangerine-500",
    backBg: "bg-tangerine-400 border-tangerine-600",
  },
  tamil: {
    label: "தமிழ்",
    voice: "ta-IN",
    ...
    frontBg: "bg-lavender-200 border-lavender-500",
    backBg: "bg-lavender-400 border-lavender-600",
  },
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-100 via-lavender-100 to-mint-100 py-6 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="font-bold text-5xl text-sky-600 drop-shadow-md mb-2">
            🗂️ Flashcards
          </h1>
          <p className="font-semibold text-xl text-sky-500 font-semibold">
        ...
        <button
          type="button"
          className="flip-card w-full h-72 cursor-pointer mb-8 text-left"
        ...
        >
          ...
          >
            {/* Front */}
            <div
              className={`flip-card-front kid-card border-4 ${config.frontBg} flex flex-col items-center justify-center p-8 gap-4`}
            >
            ...
            {/* Back */}
            <div
              className={`flip-card-back kid-card border-4 ${config.backBg} flex flex-col items-center justify-center p-8 gap-4`}
            >
              <span className="font-bold text-3xl text-white text-center leading-relaxed">
                {card?.back}
              </span>
              <button
                type="button"
