...
const NAV_CARDS = [
  ...
  },
  {
    ...
    path: "/numbers",
    bgClass: "bg-sunshine-100 border-sunshine-400 hover:bg-sunshine-200",
  ...
  },
  {
    title: "Months",
    emoji: "📅",
    description: "Learn all 12 months with pictures!",
    path: "/calendar",
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sunshine-100 via-sky-100 to-lavender-100">
      ...
      <section className="relative overflow-hidden">
        <div className="relative bg-gradient-to-r from-sky-400 via-lavender-400 to-cherry-400 py-14 px-4">
          <div className="absolute inset-0 opacity-20 pointer-events-none">
            <div className="absolute top-4 left-8 text-6xl animate-float">
              ⭐
            </div>
      ...
      {/* Welcome Modal */}
      {showWelcomeModal && <RoleSelectionModal open={showWelcomeModal} />}
