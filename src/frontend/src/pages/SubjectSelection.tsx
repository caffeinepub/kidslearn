...
const subjects = [
  {
    ...
    image: "/assets/generated/subject-math.dim_128x128.png",
  },
  {
    id: "alphabet",
    label: "Alphabet",
    ...
    image: "/assets/generated/subject-alphabet.dim_128x128.png",
  },
  {
    id: "science",
    label: "Science",
    ...
    image: "/assets/generated/subject-science.dim_128x128.png",
  },
  {
    id: "telugu",
    label: "Telugu",
    emoji: "🌺",
    color: "bg-tangerine-400",
    border: "border-tangerine-600",
    image: "/assets/generated/subject-telugu.dim_128x128.png",
  },
  {
    id: "hindi",
    label: "Hindi",
    ...
    image: "/assets/generated/subject-hindi.dim_128x128.png",
  },
  {
    id: "english",
    label: "English",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-grass-100 to-sunshine-50 px-4 py-8">
      <div className="max-w-5xl mx-auto">
          ...
          {subjects.map((subject, i) => (
            <button
              ...
              onClick={() =>
                navigate({
                  to: "/lessons",
                  search: { ageGroup, subject: subject.id },
                })
              }
            ...
            >
              ...
              <span className="font-fredoka text-white text-xl drop-shadow-sm">
                {subject.label}
              </span>
            </button>
          ))}
        ...
        {/* Activities */}
        <h2 className="font-fredoka text-3xl text-center text-tangerine-600 mb-4">
          Activities 🎯
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {activities.map((activity, i) => (
            ...
            >
              ...
              <span className="font-fredoka text-sunshine-700 text-base">
                {activity.label}
              </span>
            </button>
          ))}
        ...
        {/* Special Sections */}
        <h2 className="font-fredoka text-3xl text-center text-sky-600 mt-10 mb-4">
          Explore More 🌍
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            >
              ...
              <span className="font-fredoka text-sky-700 text-base">
                {item.label}
              </span>
            </button>
          ))}
