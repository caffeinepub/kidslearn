...
export default function PictureLesson() {
  ...
  const imgSrc = getImageForWord(item.english ?? item.word);
  ...
  return (
    ...
    >
        ...
        <div className="flex justify-center gap-2 px-2 pt-2">
          {(Object.keys(LANGUAGE_CONFIG) as Language[]).map((lang) => (
            <button
              key={lang}
              type="button"
              data-ocid={`picture.lang_${lang}.toggle`}
        ...
        <div className="flex justify-center gap-1.5 px-2 py-1.5 overflow-x-auto">
          {CATEGORIES.map((cat, i) => (
            <button
              key={cat.key}
              type="button"
              data-ocid={`picture.cat_${cat.key}.tab`}
      ...
      <div className="flex flex-col items-center justify-center h-full pt-24 pb-16 px-20 gap-4">
        ...
        <div className="flex items-center justify-center">
          {imgSrc ? (
            ...
            <span
              ...
              style={{ fontSize: "clamp(120px, 32vw, 260px)" }}
            >
              {item.emoji}
            </span>
          )}
        ...
        <button
          type="button"
          data-ocid="picture.speak.button"
      ...
      <button
        type="button"
        data-ocid="picture.pagination_prev"
        onClick={goPrev}
      ...
      <button
        type="button"
        data-ocid="picture.pagination_next"
        onClick={goNext}
